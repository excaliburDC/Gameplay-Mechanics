...
public class SwingController : MonoBehaviour
{
    ...
    void DetermineState()
    {
        ...
        else if (Input.GetButtonDown("Fire1"))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                pendulum.SwitchTetherPos(hit.point);
    ...
    {
        pendulum.arm.armLength = Mathf.Infinity;
        transform.localPosition = pendulum.FallWhenNotSwinging(transform.localPosition, Time.deltaTime);
        previousPosition = transform.localPosition;
    }
